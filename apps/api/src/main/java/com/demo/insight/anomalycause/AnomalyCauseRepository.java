...
public class AnomalyCauseRepository {
    ...
    // Find anomaly result windows that still need cause generation.
    ...
    // Upsert cause analysis and mark the source anomaly result as generated.
    ...
    /**
     * Marks a source anomaly result with cause_generated=true.
     */
